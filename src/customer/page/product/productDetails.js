      ...
      <div class='container mx-auto px-4'>
        ...
        <div class='lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16'>
              ...
              <div class='lg:order-2 lg:ml-5'>
                <div class='max-w-xl overflow-hidden rounded-lg'>
                  <img
                    ...
                    src='https://www.code-zero.com/uploads/media/25/e3/42/1652440866/polo-shirt-yachting.jpg'
                    alt=''
                  />
                </div>
              </div>
          ...
          <div class='lg:col-span-2 lg:row-span-2 lg:row-end-2'>
            <h1 class='text-left sm: text-2xl font-bold text-gray-900 sm:text-3xl'>
              Duy Bao Product
            </h1>
            ...
            <h2 class='laptop:text-2xl font-bold text-left mt-8 text-gray-900'>Color</h2>
          ...
          <div class='lg:col-span-3'>
            ...
            {/* <div class='mt-8 flow-root sm:mt-12'>
              ...
              <p class='mt-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia accusantium nesciunt
                fuga.
              </p>
              ...
              <p class='mt-4'>
                Amet consectetur adipisicing elit. Optio numquam enim facere. Lorem ipsum dolor sit
                amet consectetur, adipisicing elit. Dolore rerum nostrum eius facere, ad neque.
              </p>
            </div> */}
          </div>
        </div>
